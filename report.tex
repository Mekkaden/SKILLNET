...
{\LARGE \textbf{SkillSphere -- Campus Marketplace}}
...
This is to certify that the Project report entitled \textbf{SkillSphere -- Campus Marketplace} submitted by Apoorv Nambiar (MUT24CS043), Balasankar C B (MUT24CS049), Joel Santhosh (MUT24CS087), Richard Shaji Mekkaden (MUT24CS127) and Vishnu Prasad PV (MUT24CS150) of Semester IV is a bonafide account of the work done by them under our supervision during the academic year 2025-26.
...
This project presents the design and development of a web-based premium peer-to-peer campus marketplace named \textbf{SkillSphere}. The system is developed using modern web technologies including React for the frontend interface and Node.js with PostgreSQL for the backend operations. It provides an efficient platform for students to securely buy, sell, and trade items with verified campus peers in an organized manner.
...
PostgreSQL is used as the foundational backend database to ensure highly scalable and strictly structured relational data storage. Utilizing Node.js REST APIs for efficient data operations, the system enforces secure and optimized interactions such as fast product fetching, dynamic listing additions, and real-time UI updates. SkillSphere successfully replaces unstructured, ad-hoc trading groups (e.g., WhatsApp chats) with a centralized, reliable, and smooth student marketplace.
...
This project presents the comprehensive design and active implementation of the \textbf{SkillSphere Campus Marketplace} utilizing the PERN technological stack (PostgreSQL, Express, React, Node.js). 
